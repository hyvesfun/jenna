...
namespace Hyves.Api
{
    ...
    public enum HyvesMethod : uint
    {
        ...
        /// Retrieves an access token.
        /// </summary>
        [Description("auth.usernameLogin")]
        AuthLogin = 10508,

        [Description("custom.HyvesFotosAppLaunched")]
        CustomHyvesFotosAppLaunched = 10509,

        [Description("custom.HyvesFotosAlbumCreated")]
        CustomHyvesFotosAlbumCreated = 10510,

        [Description("custom.HyvesFotosAppError")]
        CustomHyvesFotosAppError = 10511,

        [Description("custom.HyvesFotosAppMediaUploaded")]
        CustomHyvesFotosAppMediaUploaded = 10512,
